...
- Screenshots: the landing page and guide use real 1.0 captures from the store-library fixture. Its numbers are ambitious (a 259-day streak, 64 of 52 books) and its currently-reading list repeats a title. Raised with Brian on September 16, 2026 and shipped as-is: the images are the real app, and the surrounding copy carries “a little reading counts.” Revisit when the fixture is next tuned for App Store screenshots.
