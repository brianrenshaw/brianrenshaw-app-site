...
projects=[
 ...
 ('Listing Namer','Mac app','#e9dfc8','#292b2b','listing-namer/assets/icon.png',None),
]
...
canvas.resize((1200,630),Image.Resampling.LANCZOS).save(SITE/'assets/social-projects-v5.png',optimize=True)
